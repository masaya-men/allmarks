...
type Props = {
  ...
  /** Open the file picker (discoverable fallback to paste/drop). */
  ...
  /** Copy the /s link. Resolves true on success. In the "ready" state it copies
   *  the hosted url; before that it does the thumb-less COPY LINK. */
...
export function ShareToast(props: Props): ReactElement {
  const {
    count, hint, hasImage, imagePreviewUrl, onPickFile, onClearImage,
    ...
    <div className={styles.root} style={{ zIndex: BOARD_Z_INDEX.SHARE_TOAST }} role="toolbar" aria-label="Sharing">
      <div className={styles.bar}>
        {shareUrl ? (
          ...
          <>
            <span className={styles.ready} data-testid="share-toast-ready">✓ LINK READY</span>
            <div className={styles.actions}>
              {copyBtn}
              <button type="button" className={styles.secondaryBtn} onClick={onPostToX} data-testid="share-toast-post-x">
                POST TO X
              </button>
          ...
          <>
            ...
            <div className={styles.shot}>
              ...
              <button type="button" className={styles.clearBtn} onClick={onClearImage} aria-label="Remove screenshot" data-testid="share-toast-shot-clear">
                ×
              </button>
            </div>
            <div className={styles.actions}>
              ...
              <button type="button" className={styles.secondaryBtn} onClick={onDone} data-testid="share-toast-done">
                DONE
              </button>
            </div>
          </>
          ...
          <>
            ...
            <div className={styles.actions}>
              <button type="button" className={styles.pasteChip} onClick={onPickFile} data-testid="share-toast-paste">
                PASTE / DROP SHOT
              </button>
              {copyBtn}
              <button type="button" className={styles.secondaryBtn} onClick={onReselect} data-testid="share-toast-reselect">
