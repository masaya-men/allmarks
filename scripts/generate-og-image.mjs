...
// Logo + wordmark + tagline form one vertical group, centered on the black
// canvas. Minimal by design — the user chose a logo + tagline card with no
// decorative motif. markY scales the 112×111 mark to ~159px tall and the group
// is balanced around mid-canvas (wordmark / tagline y values below).
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="${W / 2}" y="420" font-family="${FONT}" font-size="96" font-weight="700" fill="#ffffff" text-anchor="middle" letter-spacing="-2">AllMarks</text>
  <text x="${W / 2}" y="484" font-family="${FONT}" font-size="34" font-weight="400" fill="#9aa0a6" text-anchor="middle">Turn your bookmarks into a visual collage</text>
</svg>`
