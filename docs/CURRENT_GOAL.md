...
4. **タグメニューは PiP ウィンドウ全体に重なるオーバーレイ**(カルーセルの切り抜き外、ウィンドウいっぱい、暗い背景で背後を薄く)。背景クリックで閉じる。タグが全部見えるか確認。
5. **目視で詰める候補**: 「+ TAG」の位置、オーバーレイ内の TagAddPopover の幅/スクロール感(狭い窓なので窮屈なら調整)。
